...
public class RegistrationPage extends MainPage {
    ...
    private final By registrationName = By.xpath("//fieldset[1]//input");
    private final By registrationEmail = By.xpath("//fieldset[2]//input");
    private final By registrationPassword = By.xpath("//fieldset[3]//input");
